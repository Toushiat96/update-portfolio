...
const AllProject = () => {
  ...
  <div class="card">
    ...
    <div class="card-body" style={{background:' rgb(27, 61, 93)'}}>
      <h5 style={{color: "rgb(81, 233, 157)"}}>Travel Guro</h5>
      ...
      <span >React.js</span> <span >javascript</span> <span className='technology'>css</span> <span>Bootstrap</span><span >Material Ui</span>  <span>Firebase-auth</span><br/><br/>
       ...
       <a style={{fontSize:'20px',color:'white',paddingRight:'30px'}}  href="https://github.com/Toushiat96/vounteer-client"><FaGithub></FaGithub></a>
       <a style={{fontSize:'20px',color:'white',paddingRight:'30px'}}  href="https://volunteer-work-f51a7.web.app/home"><FaExternalLinkAlt></FaExternalLinkAlt></a>
    </div>
  </div>
  <div class="card">
    ...
    <div class="card-body" style={{background:' rgb(27, 61, 93)'}}>
      ...
      <span>React.js</span> <span>javascript</span> <span>css</span> <span>Bootstrap</span> <br/> <br/> <span>Material Ui</span>  <span>Firebase-auth</span>  <span>MongoDB</span><br/><br/>
       ...
       <a style={{fontSize:'20px',color:'white',paddingRight:'30px'}}  href="https://github.com/Toushiat96/creative-agency-client"><FaGithub></FaGithub></a>
       <a style={{fontSize:'20px',color:'white',paddingRight:'30px'}}  href="https://creative-agency-client-3aee9.web.app"><FaExternalLinkAlt></FaExternalLinkAlt></a>
    </div>
  </div>
  <div class="card">
    ...
    <div class="card-body" style={{background:' rgb(27, 61, 93)'}}>
      ...
      <span>React.js</span> <span>javascript</span> <span>css</span> <span>Bootstrap</span> <br/> <br/>
       ...
       <a style={{fontSize:'20px',color:'white',paddingRight:'30px'}}  href="https://github.com/Toushiat96/online-education"><FaGithub></FaGithub></a>
  ...
  <div class="card">
    ...
    <div class="card-body" style={{background:' rgb(27, 61, 93)'}}>
      ...
      <p class="text-white">This is my first javascript project. User can search the any song,and also he can see the song relize.</p> 
       ...
       <a style={{fontSize:'20px',color:'white',paddingRight:'30px'}}  href="https://github.com/Toushiat96/hard-rock"><FaGithub></FaGithub></a>
       <a style={{fontSize:'20px',color:'white',paddingRight:'30px'}}  href="https://toushiat96.github.io/hard-rock/"><FaExternalLinkAlt></FaExternalLinkAlt></a>
    </div>
  </div>
  <div class="card">
  ...
  <img class="card-img-top" src={aph} alt="Card image cap"/>
    <div class="card-body" style={{background:' rgb(27, 61, 93)'}}>
      ...
      <p class="text-white">Apartment Hunt is rent based project.Where any one can rent their house to rent . If any one can book house he can see all person who booking.</p>
       ...
       <a style={{fontSize:'20px',color:'white',paddingRight:'30px'}}  href="https://github.com/Toushiat96/apartmentHunt-client"><FaGithub></FaGithub></a>
  ...
  <img class="card-img-top" src={athena} alt="Card image cap"/>
    <div class="card-body" style={{background:' rgb(27, 61, 93)'}}>
      ...
      <p class="text-white">This design is landing page of it firm .Where provided different types of course. </p>
       ...
       <a style={{fontSize:'20px',color:'white',paddingRight:'30px'}}  href="https://github.com/Riyaz-khan-shuvo/athena-design?"><FaGithub></FaGithub></a>
