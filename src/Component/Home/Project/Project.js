  ...
  <div class="card">
    ...
    <div class="card-body" style={{background:' rgb(27, 61, 93)'}}>
      ...
      <span >React.js</span> <span >javascript</span> <span className='technology'>css</span> <span>Bootstrap</span><span >Material Ui</span>  <span>Firebase-auth</span><br/><br/>
       ...
       <a style={{fontSize:'20px',color:'white',paddingRight:'30px'}}  href="https://github.com/Toushiat96/travel-lover"><FaGithub></FaGithub></a>
       <a style={{fontSize:'20px',color:'white',paddingRight:'30px'}}  href="https://travel-lover-fe8f6.web.app/home"><FaExternalLinkAlt></FaExternalLinkAlt></a>
    </div>
  </div>
  <div class="card">
